...
public class DeviceTokenController
{
    ...
    @RequestMapping(path = "/devices/{deviceId}/tokens/{deviceTokenId}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @RequestMapping(path = "/devices/{deviceId}/tokens/{deviceTokenId}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
