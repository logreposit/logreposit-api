...
public class MessageHandler
{
    ...
    private AbstractMessageProcessor<?> getMessageProcessor(MessageType messageType) throws MessagingException
    {
        ...
        if (messageProcessor == null) {
            ...
            throw new MessagingException(String.format("Could not find MessageProcessor for Event of type '%s'", messageType));
        }
    ...
    private static MessageType getTypeOfMessage(Message message) throws MessagingException
    {
        ...
        catch (IllegalArgumentException exception)
        {
            ...
            throw new MessagingException(String.format("Could not find appropriate MessageType instance for value '%s'", message.getType()), exception);
        }
    }
}
