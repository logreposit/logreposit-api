...
public class RabbitMqMessageRecovererTests {
  ...
  @Captor private ArgumentCaptor<String> consumerQueueCaptor;
  ...
  public void setUp() {
    ...
    this.messageRecoverer =
        new RabbitMqMessageRecoverer(
            this.rabbitTemplate, new RabbitRetryStrategy(applicationConfiguration));
  }
