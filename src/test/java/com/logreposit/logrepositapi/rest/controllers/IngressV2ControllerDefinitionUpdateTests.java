...
public class IngressV2ControllerDefinitionUpdateTests
{
    ...
    @Test
    public void testDefinitionUpdate_givenValidDefinition_expectDeviceServiceCallAndSuccess() throws Exception
    {
        DeviceDefinitionDto sampleDeviceDefinitionDto = getSampleDeviceDefinitionDto();
        Device              sampleDevice              = ControllerTestUtils.sampleDevice();

        Mockito.when(this.deviceService.updateDefinition(Mockito.eq(sampleDevice.getId()), Mockito.any(DeviceDefinition.class)))
        ...
        this.controller.perform(request)
                       ...
                       .andExpect(jsonPath("$.data.measurements[0].tags").value(containsInAnyOrder("location", "sensor_id")))
                       ...
                       .andExpect(jsonPath("$.data.measurements[0].fields[0].description").value("Temperature in degrees celsius"))
        ...
        ArgumentCaptor<DeviceDefinition> deviceDefinitionArgumentCaptor = ArgumentCaptor.forClass(DeviceDefinition.class);
        ...
        assertThat(DeviceDefinitionMapper.toDto(capturedDeviceDefinition)).isEqualTo(sampleDeviceDefinitionDto);
    }

    @Test
    public void testDefinitionUpdate_givenInvalidDefinitionWithoutMeasurements_expectError() throws Exception
    {
    ...
    @Test
    public void testDefinitionUpdate_givenInvalidDefinitionWithoutFields_expectError() throws Exception
    {
    ...
    @Test
    public void testDefinitionUpdate_givenDefinitionWithInvalidMeasurementName_expectError() throws Exception
    {
    ...
    @Test
    public void testDefinitionUpdate_givenDefinitionWithInvalidTagName_expectError() throws Exception
    {
        FieldDefinitionDto fieldDefinitionDto = new FieldDefinitionDto();
    ...
    @Test
    public void testDefinitionUpdate_givenDefinitionWithInvalidFieldName_expectError() throws Exception
    {
        FieldDefinitionDto fieldDefinitionDto = new FieldDefinitionDto();
    ...
    @Test
    public void testDefinitionUpdate_givenDefinitionWithoutFieldDatatype_expectError() throws Exception
    {
        FieldDefinitionDto fieldDefinitionDto = new FieldDefinitionDto();
