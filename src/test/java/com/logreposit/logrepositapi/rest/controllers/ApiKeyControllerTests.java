...
public class ApiKeyControllerTests
{
    ...
    public void testList_customPaginationSettings_exceedsLimits() throws Exception
    {
        ...
        this.controller.perform(request)
                       ...
                       .andExpect(jsonPath("$.message").value(containsString("listApiKeys.size: size must be less or equal than 25")))
                       .andExpect(jsonPath("$.message").value(containsString("listApiKeys.page: page must be greater than or equal to 0")));
    }
